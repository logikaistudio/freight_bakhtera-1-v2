                    ...
                    <table className="w-full text-xs">
                        <thead className="bg-accent-blue/10 sticky top-0 z-10">
                            <tr>
                                ...
                                <th className="px-2 py-2 text-left text-xs font-semibold text-silver uppercase tracking-wider min-w-[384px]">Nama Pemilik</th>
                                ...
                                <th className="px-2 py-2 text-left text-xs font-semibold text-silver uppercase tracking-wider min-w-[384px]">Pengirim</th>
